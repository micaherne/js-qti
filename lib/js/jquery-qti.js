(function($, window){
	...
	window.QTI.AssessmentItem.prototype = {
		...
		_processChildren: function(qtiElement, htmlElement) {
			var self = this;
			$(qtiElement).contents().each(function(i, o){
				...
				if(o.nodeType === 3){
					...
					el[o.nodeName]({ qtiElement: o, assessmentItem: self});
	...
	$.widget("qti.choiceInteraction", {
		...
		_create: function() {
			...
			self.options.assessmentItem._processChildren(self.options.qtiElement, form);
